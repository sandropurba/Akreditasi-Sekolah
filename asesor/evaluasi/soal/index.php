<?php  ?>
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Beri Nilai Sekolah</h3>
			</div>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="alert alert-warning">
					<strong>Silahkan isi komponen instrumen sesuai dengan keadaan sekolah!</strong><br>
				</div>
			<form action="evaluasi/soal/simpan.php" method="post">
				<input type="hidden" value="<?php echo $row['npsn'];?>" name="npsn">
			<?php
			...
			<?php
			$qry2 = mysql_query("select * from nilai_sekolah where npsn='$nim'");
