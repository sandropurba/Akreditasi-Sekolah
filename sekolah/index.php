...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand navbar-right">Selamat datang <?php echo $us['sekolah']; ?></a>
			</div>
		</div><!-- /.container-fluid -->
	</nav>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li <?php if (isset($_GET['ap']) && $_GET['ap']=="identitas") echo "class='active'";?>><a href="?ap=identitas"><svg class="glyph stroked table"><use xlink:href="#stroked-open-folder"></use></svg> Identitas Sekolah</a></li>
			<li <?php if (isset($_GET['ap']) && $_GET['ap']=="evaluasi") echo "class='active'";?>><a href="?ap=evaluasi"><svg class="glyph stroked calendar"><use xlink:href="#stroked-male-user"></use></svg> Evaluasi Diri Sekolah</a></li>
